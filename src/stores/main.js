        ...
        case "u":
          Object.entries(dataContent).forEach(([key, value]) => {
            if (value.wm) {
              ...
              console.log(
                `${targetTree} updated item with key ${key}:`,
                this[targetTree][key]
              );
            }
          });
    ...
    processNestedWriteMode(targetTree, nestedData) {
      ...
      switch (nestedWriteMode) {
        case "f":
          ...
          console.log(
            `Nested full update for ${targetTree} item with ID ${nestedId}:`,
        ...
        case "u":
          if (nestedId) {
            ...
            console.log(
              `Nested update for ${targetTree} item with ID ${nestedId}:`,
              this[targetTree][nestedId]
            );
          }
          break;
        ...
        case "rm":
          if (nestedId) {
            ...
            console.log(
              `Nested remove for ${targetTree} item with ID ${nestedId}`
            );
          }
          break;
